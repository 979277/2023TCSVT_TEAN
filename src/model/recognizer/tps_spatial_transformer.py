...
#import sys
#sys.path.append('/home/ubuntu/shurui/TextZoom-master/src/model/')
#from model.tsrn import GruBlock
...
class TPSSpatialTransformer(nn.Module):
  ...
  def forward(self, input, source_control_points):
    ...
    #input=self.grubb(input.transpose(-1,-2)).transpose(-1,-2)
...
class TPSSpatialTransformer1(nn.Module):

  def __init__(self, output_image_size=None, num_control_points=None, margins=None):
    super(TPSSpatialTransformer1, self).__init__()
    self.output_image_size = output_image_size
    self.num_control_points = num_control_points
    self.margins = margins
